...
```bash
git clone https://github.com/<username>/next-link
```
...
[license]: https://github.com/bradgarropy/next-link/blob/master/license
[fork]: https://github.com/bradgarropy/next-link/fork
[contributors]: https://github.com/bradgarropy/next-link#-contributors
